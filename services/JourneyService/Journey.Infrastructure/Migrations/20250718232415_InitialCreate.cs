        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPublicLinkRevoked = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JourneyShare", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JourneyShare_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JourneyShare_Journeys_JourneyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JourneyShare_JourneyId",
                table: "JourneyShare",
                column: "JourneyId");

            migrationBuilder.CreateIndex(
                name: "IX_JourneyShare_UserId",
                table: "JourneyShare",
                column: "UserId");
        }
